    ...
    return (
        <div className="bg-black flex h-screen justify-center items-center ">
            ...
            <div className='flex flex-col justify-center items-center h-screen'>
                <h1 className='font-sora text-xl md:text-3xl font-bold text-white'>{text}</h1>
                <Lottie animationData={animationData} className='w-full  h-auto'/>
            </div>
            ) : (
            <div className="flex flex-col items-center ">
                <div className="text-container">
                    <h2 className="text-[20px] md:text-2xl font-bold font-sora  text-white">Ddreyy Github Repositories</h2>
                ...
                {currentRepos.map((repo, index) => (
                    <li
                    key={repo.id}
                    className={`mb-2 border bg-[#212F3E] rounded py-5 md:py-6 px-10 sm:px-14 ${
                    ...
                    <Link
                        ...
                        className="text-[#C8D6E5] text-base md:text-2xl hover:underline font-satoshi"
                    >     
                        {repo.name}
                    </Link>
                ...
                <div className="mt-4 flex space-x-4">
                    <button
                    className={`bg-[#E1D9D1] hover:bg-[#676767] hover:text-white transition-transform duration-400 ease-in-out transform hover:scale-105 text-black font-bold font-sora py-2 px-4 rounded-l ${
                    ...
                    <button
                    className={`bg-[#E1D9D1] hover:bg-[#676767] hover:text-white transition-transform duration-400 ease-in-out transform hover:scale-105 text-black font-bold font-sora py-2 px-4 rounded-r ${
